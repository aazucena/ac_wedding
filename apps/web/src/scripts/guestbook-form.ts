...
const successBody = document.getElementById(
  "gb-success-body",
) as HTMLElement | null;
...
const nameConfirmed = document.getElementById(
  "name-confirmed",
) as HTMLElement | null;
const nameConfirmTxt = document.getElementById(
  "name-confirmed-text",
) as HTMLElement | null;
const nameChangeBtn = document.getElementById(
  "name-change-btn",
) as HTMLButtonElement | null;
...
if (!form || !nameInput || !msgTextarea)
  throw new Error("GuestbookForm: missing elements");
...
form.addEventListener("submit", async (e) => {
  ...
  if (successEl) successEl.style.display = "";
  if (successTitle)
    successTitle.textContent = data.verified
      ? "Message published!"
      : "Message received!";
  if (successBody) {
