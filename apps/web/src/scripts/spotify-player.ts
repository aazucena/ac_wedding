document.addEventListener("astro:page-load", () => {
  document
    .querySelectorAll<HTMLElement>(".spotify-player-toggle")
    .forEach((btn) => {
      ...
      player
        .querySelector<HTMLElement>(".spotify-logo-link")
  ...
  _window.onSpotifyIframeApiReady = (IFrameAPI: any) => {
    ...
    IFrameAPI.createController(
      ...
      (EmbedController: any) => {
        ...
        const skeleton =
          player?.querySelector<HTMLElement>(".spotify-skeleton");
        const dot = player?.querySelector<HTMLElement>(
