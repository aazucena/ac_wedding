...
let _deviceOrientationHandler: ((e: DeviceOrientationEvent) => void) | null = null;
...
function cleanup() {
  ...
  if (_deviceOrientationHandler) { window.removeEventListener('deviceorientation', _deviceOrientationHandler); _deviceOrientationHandler = null; }
}
...
function initHero() {
  ...
  if (!window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    ...
    if (typeof DeviceOrientationEvent !== 'undefined') {
      ...
      window.addEventListener('deviceorientation', _deviceOrientationHandler, { passive: true });
    }
