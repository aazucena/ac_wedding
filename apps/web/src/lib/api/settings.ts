  ...
  try {
    return await get<WeddingSettings>("/items/wedding_settings", {
      fields: [
        ...
        "bride.last_name",
        "bride.middle_name",
        "bride.preferred_name",
        "groom.id",
        "groom.first_name",
        "groom.last_name",
        "groom.middle_name",
        "groom.preferred_name",
        "story.id",
        "story.title",
        "story.headline",
        "story.summary",
        "story.cover_image.id",
        "story.cover_image.width",
        "story.cover_image.height",
        "story.cover_image.focal_point_x",
        "story.cover_image.focal_point_y",
        "story.chapters.id",
        "story.chapters.sort",
        "story.chapters.headline",
        "story.chapters.icon",
        "story.chapters.title",
        "story.chapters.content",
        "story.chapters.image.id",
        "story.chapters.image.width",
        "story.chapters.image.height",
        "story.chapters.image.focal_point_x",
        "story.chapters.image.focal_point_y",
        "accomodation.id",
        "accomodation.sort",
        ...
        "accomodation.vendor.address_line1",
        "accomodation.vendor.city",
        "accomodation.vendor.phone",
        "accomodation.vendor.website",
        "accomodation.vendor.maps_url",
        "ceremony.start_time",
        "ceremony.estimated_duration",
        "ceremony.venue.name",
...
export async function getMaintenanceStatus(): Promise<boolean> {
  try {
    const data = await get<WeddingSettings>("/items/wedding_settings", {
      fields: ["maintenance"],
    });
