...
export function buildDM(d: CardData, photo: string | null, t: Theme): El {
  ...
  const rightPanel = h(
    "div",
    {
      ...
      borderLeftColor: "rgba(197,184,224,0.35)",
    },
    h(
      "div",
      {
    ...
    h(
      ...
      h("div", {
        flex: 1,
        height: 1,
        backgroundImage: `linear-gradient(90deg, rgba(197,184,224,0.3), transparent)`,
      }),
      h("div", { fontFamily: "CG", fontSize: 8, color: LAVENDER }, "◆"),
      h("div", {
        flex: 1,
        height: 1,
        backgroundImage: `linear-gradient(90deg, transparent, rgba(197,184,224,0.3))`,
      }),
    ),
    h("div", { height: 20 }),
    ...
    h(
      ...
      `${d.receptionTime}  ·  ${d.location}`,
    ),

    h("div", { height: 28 }),
    h("div", {
      height: 1,
      backgroundImage: `linear-gradient(90deg, rgba(197,184,224,0.25), transparent)`,
      marginBottom: 16,
    }),
    h(
      "div",
  ...
  return h(
    ...
    h(
      "div",
      {
        ...
        color:
          t === THEMES.dark
            ? "rgba(197,184,224,0.05)"
            : "rgba(197,184,224,0.12)",
      },
      `${d.bride[0]}${d.groom[0]}`,
    ),
