...
export function h(tag: string, style: Record<string, any> = {}, ...children: Child[]): El {
...
export function photoScrim(w: number, h_: number, photoSrc: string, t: Theme, scrimDir = 'to top'): El[] {
  return [
    {
      type: 'img',
      props: {
