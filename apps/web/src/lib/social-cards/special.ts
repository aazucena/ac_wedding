...
export function buildVignette(d: CardData, photo: string | null, t: Theme): El {
  ...
  if (photo) {
    return h(
      ...
      h("div", {
        ...
        height: H,
        backgroundImage:
          "radial-gradient(ellipse at center, transparent 28%, rgba(10,10,25,0.68) 100%)",
      }),
      textContent,
    );
  }
  ...
  return h(
    ...
    h("div", {
      ...
      width: W,
      height: H,
      backgroundImage: `radial-gradient(ellipse at center, transparent 40%, ${t.scrimStart} 100%)`,
    }),
    textContent,
  );
}

export function buildBordered(
  d: CardData,
  _photo: string | null,
  t: Theme,
): El {
  ...
  return h(
    ...
    h("div", {
      ...
      borderWidth: 1,
      borderStyle: "solid",
      borderColor: "rgba(197,184,224,0.55)",
    }),
    h("div", {
      position: "absolute",
      top: INNER,
      ...
      borderWidth: 1,
      borderStyle: "solid",
      borderColor: "rgba(197,184,224,0.30)",
    }),
    textContent,
  );
}
...
export function buildEngagement(
  ...
  const content = h(
    ...
    h("div", {
      height: 1,
      width: 360,
      backgroundImage: `linear-gradient(90deg, transparent, ${LAVENDER}, transparent)`,
    }),
    h("div", { height: 32 }),
