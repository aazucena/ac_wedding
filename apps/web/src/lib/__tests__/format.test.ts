...
import { formatTime, formatDate, assetUrl, toTelHref, getCountdown } from '../utils/format';
...
describe('assetUrl', () => {
  ...
  it('appends qs-encoded query params', () => {
    expect(assetUrl('abc-123', { width: 600, fit: 'cover' }))
      .toBe('/assets/abc-123?width=600&fit=cover');
  });
